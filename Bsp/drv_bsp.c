...
{
    BSP_DC_LU(static_cast<Enum_BSP_DC24_Status>((Status & BSP_DC_LU_ON) == 0 ? BSP_DC24_Status_DISABLED : BSP_DC24_Status_ENABLED));
    BSP_DC_LD(static_cast<Enum_BSP_DC24_Status>((Status & BSP_DC_LD_ON) == 0 ? BSP_DC24_Status_DISABLED : BSP_DC24_Status_ENABLED));
    BSP_DC_RU(static_cast<Enum_BSP_DC24_Status>((Status & BSP_DC_RU_ON) == 0 ? BSP_DC24_Status_DISABLED : BSP_DC24_Status_ENABLED));
    BSP_DC_RD(static_cast<Enum_BSP_DC24_Status>((Status & BSP_DC_RD_ON) == 0 ? BSP_DC24_Status_DISABLED : BSP_DC24_Status_ENABLED));

    BSP_LED_R(static_cast<Enum_BSP_LED_Status>((Status & BSP_LED_RED_ON) == 0 ? BSP_LED_Status_DISABLED : BSP_LED_Status_ENABLED));
    BSP_LED_G(static_cast<Enum_BSP_LED_Status>((Status & BSP_LED_GREEN_ON) == 0 ? BSP_LED_Status_DISABLED : BSP_LED_Status_ENABLED));
 ...
 *
 * @param Status 状态
 * @param static_cast<目标类型>(你要转换的变量)
 */
