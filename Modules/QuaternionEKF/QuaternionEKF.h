...
#ifndef QEKF_MPU6500_GYRO_LSB_PER_DPS
#define QEKF_MPU6500_GYRO_LSB_PER_DPS 16.384f
#endif

#ifndef QEKF_MPU6500_ACCEL_LSB_PER_G
#define QEKF_MPU6500_ACCEL_LSB_PER_G 4096.0f
#endif

#ifndef QEKF_GRAVITY
#define QEKF_GRAVITY 9.80665f
#endif
...
typedef struct
{
    ...
    float gravity;
    int8_t gyro_axis_map[3];
    int8_t accel_axis_map[3];
} QEKF_MPU6500_Config_t;
...
typedef struct
{
    ...
    QEKF_MPU6500_Config_t Mpu6500Cfg;
} QEKF_INS_t;
